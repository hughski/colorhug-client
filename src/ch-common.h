...
#define	CH_EEPROM_ADDR_DARK_OFFSET_RED		0x2e /* 2 bytes, LE */
#define	CH_EEPROM_ADDR_DARK_OFFSET_GREEN	0x30 /* 2 bytes, LE */
#define	CH_EEPROM_ADDR_DARK_OFFSET_BLUE		0x32 /* 2 bytes, LE */
